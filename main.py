...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = .4 # pourcentage in screen width (largeur des cases) ou taille du terrain
    vertical_lines = []
    ...
    SPEED_X = 3.5  # La vitesse horizontale 
    current_speed_x = 0
    current_offset_x = 0
    ...
    menu_title = StringProperty("N   S   U   K   U   L   A")
    ...
    def pre_fill_tiles_coordinates(self):
        # 10 tiles en ligne droite pour la préparation du joueur
        for i in range(0, 10):
